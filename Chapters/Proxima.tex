\chapter{Spectra of \prox} % Main chapter title
\protect\label{chapter:proxima}
\lhead{Chapter 3. \emph{Spectra of \prox}}
...
%together wish some additional data collected between 19 Jan 2016 and 30 Mar 2016.
...
% The number of pixels could vary by one due to differing
% wavelength corrections caused by the heliocentric component of the Radial Velocities. However the interpolation
% adjustment proved unnecessary for Peak Ratios, being based upon the mean values of the points in the selected ranges.
...
\caption{In the left panel the {\ha} region of example spectra of {\prox} taken from {\harps} on 27 May 2004 02:10:14
  ...
  other papers.% Dotted vertical lines in the left panel are TiO transitions identified from the VALD.
% the shaded dark green
%  region in the right panel from 6572.468{\AA} to 6573.288{\AA} show the prominent TiO I transition line referred to in

...
\examrevision{With the Original Set of data, all the measurements, except for the peak ratio, returned the 116.6-day
  ...
  Fig. \ref{fig:harpswfos} and Fig. \ref{fig:harpswffs}. It can be seen that 116.5 days can be found as a peak in the
  window function for the Original Set, suggesting this as the cause of this period in periodograms derived from this
  data.}
...
\caption{\examrevision{Window function of Original Set of {\harps} data (observation times up to January 2014), with
    peaks highlighted in the area of 100 to 130 days, showing peak at 116.5 days, which appeared in several of the
    periodograms (for all measurements except peak ratio). The slightly weaker 124.0-day peak was also observed in some of
    the periodograms.}}
...
\caption{\examrevision{Window function of Full Set of {\harps} data (observation times up to March 2016), with
    peaks highlighted in the area of 100 to 130 days. In this case there was no peak at 116.5 days as observed in
    Fig. \ref{fig:harpswfos}. One instance of each the 108.5-day and 113.0-day periods were found in the
    periodogram results for the Full Set of data, not nearly as many, however, as were observed of the 116.5-day period in
    measurements applied to the Original Set.}}

...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[scale=0.40]{Figures/harpswfos-orig.png} \\
\end{center}   
\caption{\examrevision{Window function of Original Set of {\harps} data (observation times up to January 2014), with
    peaks highlighted in the area of 90 to 130 days, showing a peak at 116.5 days, which appeared in several of the
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[scale=0.40]{Figures/harpswffs-orig.png} \\
\end{center}   
\caption{\examrevision{Window function of Full Set of {\harps} data (observation times up to March 2016), with
    peaks highlighted in the area of 100 to 130 days. In this case there \examrevisiona{was no peak at 116.6 days} as observed in
    Fig. \ref{fig:harpswfos}, however the 124-day peak was noticed in a few of the periodogram results.}}

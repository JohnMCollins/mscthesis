...
This suggests the possibility that this period is an alias thrown up by the observation times as indeed possibly the
strong 77.8-day period seen in the {\hst} data but not in the {\asas} data is a similar
alias. %In Section ?? the interactions between competing periods are
%considered further.

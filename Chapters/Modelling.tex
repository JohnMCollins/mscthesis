...
which were copied from the Original Set of {\harps} data for use in the model, \examrevisionb{although it was not
  possible to confirm this from the window function of the data, as shown in Fig. \ref{fig:harpswfos}.}

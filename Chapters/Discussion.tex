...
width measure. This points to the need for a properly-constructed 3D model, \forcomment{taking into account activity
  in the chromosphere and corona other than close to the photosphere and not possible to model with a simple spherical
  shell}, to properly understand the behaviour of \prox.

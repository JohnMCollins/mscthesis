...
\examrevision{It was not possible to use any of these routines to calculate window functions by supplying a constant value of
intensity, all either generated overflows or reported zero values.}

\examrevisiona{The Window functions were all produced using \textit{Period04}. It was not practical to use this
  throughout, particularly with the modelling as a ``batch mode'' as opposed to a ``GUI'' style of operation was required.}
